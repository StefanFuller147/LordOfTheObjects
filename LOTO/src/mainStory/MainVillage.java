...
public class MainVillage {
	...
	public static void startingVillage(HeroTemplate hero) {
		...
		st.stHalf(
				"You are approached by a local crier, they walk up to you and ask if you'd like a quick tour of the town.");
	...
	public static void whereToGoInTown(HeroTemplate hero) {
		...
		do {
			...
			if (placeInTownToGo > 4 || placeInTownToGo < 1) {
				System.out.println(placeInTownToGo
						+ " is not a valid option dipshit, try again. This time in the number range given");
			}
